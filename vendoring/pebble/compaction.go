...
import (
	...
	"github.com/idrecun/go-ethereum/vendoring/pebble/internal/private"
	"github.com/idrecun/go-ethereum/vendoring/pebble/internal/rangedel"
	"github.com/idrecun/go-ethereum/vendoring/pebble/internal/rangekey"
	"github.com/idrecun/go-ethereum/vendoring/pebble/objstorage"
	"github.com/idrecun/go-ethereum/vendoring/pebble/objstorage/objstorageprovider/objiotracing"
	...
	if err == nil {
		...
		if err != nil {
			...
			for _, f := range pendingOutputs {
				...
				// https://github.com/idrecun/go-ethereum/vendoring/pebble/issues/389 is
