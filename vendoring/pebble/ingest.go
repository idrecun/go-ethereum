...
// https://github.com/idrecun/go-ethereum/vendoring/pebble/pull/835#issuecomment-663075379
//
...
// https://github.com/idrecun/go-ethereum/vendoring/pebble/issues/25 for an idea for how to fix
// this hiccup.
...
func (d *DB) ingest(
	...
	prepare := func(seqNum uint64) {
		...
		if d.FormatMajorVersion() < FormatFlushableIngest ||
			...
			// comment. Tracking issue: https://github.com/idrecun/go-ethereum/vendoring/pebble/issues/2676
...
func (d *DB) excise(
	...
	// https://github.com/idrecun/go-ethereum/vendoring/pebble/issues/2112 .
